...
| generic_condition | Generic Condition | LGPL-3 | 18.0.1.22.5 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_resource | Generic Resource | LGPL-3 | 18.0.1.51.4 | Provides the ability to create and categorize         various resources that can be used in other Odoo modules. |  |
...
| generic_team | Generic team | LGPL-3 | 18.0.1.21.3 | With this module you can create teams and add         users to them, which allows you to perform group         actions (such as assigning a responsible team         instead of one person) while working with Odoo applications. |  |
