...
| generic_mixin | Generic Mixin | LGPL-3 | 14.0.1.56.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| generic_service | Generic Service | LGPL-3 | 14.0.1.15.0 | Create and manage service catalog |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 14.0.0.13.0 | Technical module that have to be used to test Generic Mixin module |  |
