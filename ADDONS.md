...
| generic_mixin | Generic Mixin | LGPL-3 | 18.0.1.82.4 | Technical module with generic mixins, that may help to build other modules |  |
...
| generic_team | Generic team | LGPL-3 | 18.0.1.21.2 | With this module you can create teams and add         users to them, which allows you to perform group         actions (such as assigning a responsible team         instead of one person) while working with Odoo applications. |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 18.0.0.23.3 | Technical module that have to be used to test Generic Mixin module |  |
