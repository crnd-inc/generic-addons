...
| generic_mixin | Generic Mixin | LGPL-3 | 15.0.1.55.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| generic_service | Generic Service | LGPL-3 | 15.0.1.14.0 | Create and manage service catalog |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 15.0.0.12.0 | Technical module that have to be used to test Generic Mixin module |  |
