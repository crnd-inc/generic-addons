...
| generic_mixin | Generic Mixin | LGPL-3 | 14.0.1.82.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 14.0.0.24.0 | Technical module that have to be used to test Generic Mixin module |  |
