...
| generic_mixin | Generic Mixin | LGPL-3 | 18.0.1.83.1 | Technical module with generic mixins, that may help to build other modules |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 18.0.0.25.1 | Technical module that have to be used to test Generic Mixin module |  |
