...
| generic_condition | Generic Condition | LGPL-3 | 14.0.1.5.0 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_condition_test | Generic Condition - Test | LGPL-3 | 14.0.1.4.0 | Generic Conditions - Tests (do not install manualy) |  |
| generic_crypto_utils | Generic Crypto Utils | LGPL-3 | 14.0.0.1.0 | Technical utils to add encryption to other addons |  |
| generic_location | Generic Location | LGPL-3 | 14.0.1.4.1 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 14.0.1.11.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 14.0.0.3.0 | Technical module that have to be used to test Generic Mixin module |  |
