...
| generic_condition | Generic Condition | LGPL-3 | 17.0.1.23.0 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 17.0.1.84.0 | Technical module with generic mixins, that may help to build other modules |  |
| generic_rule | Generic Rule | LGPL-3 | 17.0.1.9.0 | Adds new top-level menu 'rules' |  |
| generic_tag | Generic Tag | LGPL-3 | 17.0.2.16.4 | Generic tag management. |  |
