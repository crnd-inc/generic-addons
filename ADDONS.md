...
| generic_location | Generic Location | LGPL-3 | 15.0.1.13.1 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
...
| generic_location_uuid | Generic Location (UUID) | LGPL-3 | 15.0.1.2.0 | Generic Location (Add UUID to generic locations) |  |
| generic_m2o | Generic M2O Widget | LGPL-3 | 15.0.1.4.0 | Generic Many2one widget |  |
| generic_mixin | Generic Mixin | LGPL-3 | 15.0.1.57.0 | Technical module with generic mixins, that may help to build other modules |  |
| generic_resource | Generic Resource | LGPL-3 | 15.0.1.33.0 | Provides the ability to create and categorize         various resources that can be used in other Odoo modules. |  |
| generic_rule | Generic Rule | LGPL-3 | 15.0.1.1.1 | Adds new top-level menu 'rules' |  |
| generic_service | Generic Service | LGPL-3 | 15.0.1.16.0 | Create and manage service catalog |  |
...
| generic_team | Generic team | LGPL-3 | 15.0.1.13.0 | With this module you can create teams and add         users to them, which allows you to perform group         actions (such as assigning a responsible team         instead of one person) while working with Odoo applications. |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 15.0.0.13.0 | Technical module that have to be used to test Generic Mixin module |  |
