...
| generic_location | Generic Location | LGPL-3 | 12.0.1.12.0 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 12.0.1.53.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| generic_service | Generic Service | LGPL-3 | 12.0.1.14.0 | Create and manage service catalog |  |
