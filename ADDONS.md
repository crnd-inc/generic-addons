...
| generic_condition | Generic Condition | LGPL-3 | 17.0.1.22.2 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 17.0.1.82.1 | Technical module with generic mixins, that may help to build other modules |  |
