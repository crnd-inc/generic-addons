...
| generic_mixin | Generic Mixin | LGPL-3 | 12.0.1.33.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 12.0.0.7.0 | Technical module that have to be used to test Generic Mixin module |  |
