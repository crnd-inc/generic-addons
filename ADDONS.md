...
| generic_mixin | Generic Mixin | LGPL-3 | 18.0.1.84.5 | Technical module with generic mixins, that may help to build other modules |  |
| generic_rule | Generic Rule | LGPL-3 | 18.0.1.9.1 | Adds new top-level menu 'rules' |  |
| generic_tag | Generic Tag | LGPL-3 | 18.0.2.16.7 | Generic tag management. |  |
| generic_tag_test | Generic Tag - Test | LGPL-3 | 18.0.1.8.1 | Generic Tag - Tests (do not install manualy) |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 18.0.0.25.4 | Technical module that have to be used to test Generic Mixin module |  |
