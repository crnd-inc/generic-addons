...
| generic_location | Generic Location | LGPL-3 | 15.0.2.8.0 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
...
| generic_rule | Generic Rule | LGPL-3 | 15.0.1.6.0 | Adds new top-level menu 'rules' |  |
