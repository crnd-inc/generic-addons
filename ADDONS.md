...
| generic_condition | Generic Condition | LGPL-3 | 14.0.1.10.1 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_location | Generic Location | LGPL-3 | 14.0.1.7.1 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
