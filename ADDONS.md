...
| generic_location | Generic Location | LGPL-3 | 12.0.2.1.0 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
...
| generic_resource | Generic Resource | LGPL-3 | 12.0.1.42.0 | Provides the ability to create and categorize         various resources that can be used in other Odoo modules. |  |
