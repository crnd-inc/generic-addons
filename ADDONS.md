...
| generic_condition | Generic Condition | LGPL-3 | 18.0.1.22.7 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 18.0.1.84.3 | Technical module with generic mixins, that may help to build other modules |  |
| generic_rule | Generic Rule | LGPL-3 | 18.0.1.9.1 | Adds new top-level menu 'rules' |  |
| generic_tag | Generic Tag | LGPL-3 | 18.0.2.16.5 | Generic tag management. |  |
