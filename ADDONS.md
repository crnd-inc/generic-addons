...
| generic_location_uuid | Generic Location (UUID) | LGPL-3 | 13.0.1.3.0 | Generic Location (Add UUID to generic locations) |  |
| generic_m2o | Generic M2O Widget | LGPL-3 | 13.0.1.4.0 | Generic Many2one widget |  |
| generic_mixin | Generic Mixin | LGPL-3 | 13.0.1.58.0 | Technical module with generic mixins, that may help to build other modules |  |
...
| generic_service | Generic Service | LGPL-3 | 13.0.1.16.0 | Create and manage service catalog |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 13.0.0.13.0 | Technical module that have to be used to test Generic Mixin module |  |
