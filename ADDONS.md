...
| generic_condition | Generic Condition | LGPL-3 | 12.0.1.8.0 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_location | Generic Location | LGPL-3 | 12.0.1.6.0 | Allows you to make an abstract description of the         objects location relative to the general location         (for example: house3 -> office5 -> room2 -> table5) |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 12.0.1.26.0 | Technical module with generic mixins, that may help to build other modules |  |
| generic_rule | Generic Rule | LGPL-3 | 12.0.1.1.1 | Adds new top-level menu 'rules' |  |
| generic_tag | Generic Tag | LGPL-3 | 12.0.2.2.0 | Generic tag management. |  |
