...
| generic_condition | Generic Condition | LGPL-3 | 16.0.1.23.0 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 16.0.1.84.0 | Technical module with generic mixins, that may help to build other modules |  |
| generic_resource | Generic Resource | LGPL-3 | 16.0.1.52.0 | Provides the ability to create and categorize         various resources that can be used in other Odoo modules. |  |
...
| generic_tag | Generic Tag | LGPL-3 | 16.0.2.16.1 | Generic tag management. |  |
...
| generic_team | Generic team | LGPL-3 | 16.0.1.22.0 | With this module you can create teams and add         users to them, which allows you to perform group         actions (such as assigning a responsible team         instead of one person) while working with Odoo applications. |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 16.0.0.25.0 | Technical module that have to be used to test Generic Mixin module |  |
| test_generic_resource_search | Tests Generic Resource (Search Tests) | LGPL-3 | 16.0.0.6.0 | Technical module that have to be used to test Generic Resource search cases |  |
