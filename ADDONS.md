...
| generic_condition | Generic Condition | LGPL-3 | 12.0.1.9.0 | Create generic conditions on which you         can program some logic in Odoo objects |  |
...
| generic_mixin | Generic Mixin | LGPL-3 | 12.0.1.28.0 | Technical module with generic mixins, that may help to build other modules |  |
