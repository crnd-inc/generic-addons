...
| generic_resource | Generic Resource | LGPL-3 | 13.0.1.41.0 | Provides the ability to create and categorize         various resources that can be used in other Odoo modules. |  |
...
| test_generic_mixin | Generic Mixin (Tests) | LGPL-3 | 13.0.0.19.0 | Technical module that have to be used to test Generic Mixin module |  |
